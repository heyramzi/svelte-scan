...
import { getSvelteInternals } from '#src/core/internals'
import { DEFAULT_CONFIG, type SvelteScanConfig } from '#src/core/types'
import { readConfig } from '#src/core/config-storage'
import { svibe } from '#src/api'
...
import { createConsoleObserver } from '#src/observers/console'
import { createServerObserver } from '#src/observers/server'
import { createHmrObserver } from '#src/observers/hmr'
import { createInteractionObserver } from '#src/observers/interactions'
import { createCanvasOverlay } from '#src/ui/canvas-overlay'
import { TOOLBAR_STYLES } from '#src/ui/toolbar-styles'
import { INSPECTOR_STYLES } from '#src/ui/inspector-styles'
import Toolbar from '#src/ui/Toolbar.svelte'
